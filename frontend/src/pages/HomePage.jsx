        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-xl text-base-content/70 leading-relaxed max-w-xl">
              ...
              Conduct live coding sessions, communicate effortlessly, and make smarter hiring decisions.
            </p>
            {/* FEATURE PILLS */}
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body items-center text-center">
              ...
              <p className="text-base-content/70">
                Collabrate in real-time with syntax highlighting and multiple language support
              </p>
          ...
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body items-center text-center">
              ...
              <p className="text-base-content/70">
                Share your screen, discuss solution, and learn from others in real-time
              </p>
            </div>
          </div>
          <div>
